...
template B<long>::B(C); \
template B<unsigned long long>::B(C); \
template B<long long>::B(C); \
template B<float>::B(C); \
template B<double>::B(C); \
template B<long double>::B(C);

#define TEMPLATES_CONST_WITH_ARG(B,C,D) \
template B<unsigned char>::B(C,D); \
template B<char>::B(C,D); \
template B<unsigned short>::B(C,D); \
template B<short>::B(C,D); \
template B<unsigned int>::B(C,D); \
template B<int>::B(C,D); \
template B<unsigned long>::B(C,D); \
template B<long>::B(C,D); \
template B<unsigned long long>::B(C,D); \
template B<long long>::B(C,D); \
template B<float>::B(C,D); \
template B<double>::B(C,D); \
template B<long double>::B(C,D);
...
template B<long>::~B(); \
template B<unsigned long long>::~B(); \
template B<long long>::~B(); \
template B<float>::~B(); \
template B<double>::~B(); \
...
template A<unsigned long long>::A( const A<unsigned long long>& other); \
template A<long long>::A( const A<long long>& other); \
...
template A<unsigned long long>& A<unsigned long long>::operator B( const A<unsigned long long>& other); \
template A<long long>& A<long long>::operator B( const A<long long>& other); \
...
template A B<unsigned long long>::C(D); \
template A B<long long>::C(D); \
...
template A B<unsigned long long>::C(D,unsigned long long E); \
template A B<long long>::C(D,long long E); \
...
template A B<unsigned long long>::C(D,std::vector<unsigned long long> E); \
template A B<long long>::C(D,std::vector<long long> E); \
...
template unsigned long long B<unsigned long long>::C(D); \
template long long B<long long>::C(D); \
...
template unsigned long long B<unsigned long long>::C(D) const; \
template long long B<long long>::C(D) const; \
template float B<float>::C(D) const; \
template double B<double>::C(D) const; \
template long double B<long double>::C(D) const;

#define TEMPLATES_ISOLATED_FUNC(A,B,C) \
template A B<unsigned char>(C); \
template A B<char>(C); \
template A B<unsigned short>(C); \
template A B<short>(C); \
template A B<unsigned int>(C); \
template A B<int>(C); \
template A B<unsigned long>(C); \
template A B<long>(C); \
template A B<unsigned long long>(C); \
template A B<long long>(C); \
template A B<float>(C); \
template A B<double>(C); \
template A B<long double>(C);
#endif
